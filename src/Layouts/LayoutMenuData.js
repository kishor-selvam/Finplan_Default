...
const Navdata = () => {
    ...
    useEffect(() => {
        ...
        if (iscurrentState !== 'Screen') {
            setIsScreen(false);
        }
        if (iscurrentState !== 'Kishor') {
            setIsKishor(false);
        }
    ...
    const menuItems = [
        ...
        //     icon: "ri-honour-line",
        //     link: "/#",
        //     stateVariables: isKishor,
        //     click: function (e) {
        //     e.preventDefault();
        //     setIsKishor(!isKishor);
        //     setIscurrentState('Kishor');
        //     updateIconSidebar(e);
        // },
        //     subItems: [
        //         {
