...
import AssetChart from "../pages/Screen/Assets";
...
const authProtectedRoutes = [
  ...
  { path: "/screen/income", component: <Income /> },
  { path: "/screen/networth", component: <NetWorth /> },
  { path: "/screen/savings", component: <Savings /> },
  { path: "/screen/liabilities", component: <Charts /> },
