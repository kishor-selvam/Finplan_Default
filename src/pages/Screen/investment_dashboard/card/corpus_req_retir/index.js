...
const CorpusReqRetirChartCard = () => {
    ...
    return (
        <div className='card corpusReqRetirChart'>
            <div className='card-body chart__box'>
                ...
                <div className='chart_main'>
                    <div className='chart_amout'>
                        <div className='chart__title'>Corpus Required Retirement</div>
                        {
                            year === '2023' ? 
                                <CountUp
                                    start={300000}
...
export default CorpusReqRetirChartCard;